...
import ShahzadHeadshot from "/public/images/shahzad-headshot.jpeg";
        ...
        <div className="flex flex-col gap-12 md:flex-row">
          ...
          <div className="flex items-center justify-center md:order-last md:flex-grow md:justify-end">
            <motion.div
              ...
              className="relative h-[300px] w-[280px] md:h-[360px] md:w-[320px]"
            >
              <Image
                src={ShahzadHeadshot}
          ...
          <div className="flex max-w-3xl flex-grow flex-col justify-center gap-8 md:order-first md:items-start md:justify-center 2xl:gap-12">
            <div className="flex flex-col gap-2">
              ...
              <Typography>
                ...
                focus on creating (and occasionally designing dashboards)
                exceptional digital experiences that are fast, accessible,
                visually appealing, and responsive. Even though I have been
                creating web applications for over 3 years, I still love it as
            ...
            <div className="flex flex-col gap-2">
              <div className="flex gap-2">
                ...
                <Typography>Islamsbad</Typography>
              </div>
