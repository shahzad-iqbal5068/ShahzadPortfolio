  ...
  return (
    <Container className="bg-gray-50" id="about">
      ...
      <motion.div
        ...
        className="flex w-full flex-col justify-between gap-12 md:flex-row"
      >
        {/* Image */}
        <motion.div
        ...
        <div className="flex max-w-xl flex-col gap-6">
          ...
          <Typography>
            ...
            Software Engineer
            {" "}
            who specializes in full stack development (React.js & Node.js). I am enthusiastic about bringing the technical and visual
